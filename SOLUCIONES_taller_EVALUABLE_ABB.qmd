...
aux_price = listing_common0_select %>% select(id,
                                              date, 
                                              price, 
...
# --- Analizamos reviews ---        
aux_reviews = listing_common0_select %>% select(id,
                                              date, 
                                              number_of_reviews, 
                                              neighbourhood_cleansed)
...
price2 = listing_common0_select %>% filter(neighbourhood_cleansed %in% c("Pollença", "Palma de Mallorca") & date == "2024-09-13")
...
# --- Analizamos reviews ---
# Filtrar los datos
reviews2 = listing_common0_select %>%
